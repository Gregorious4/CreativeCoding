...
function obstacles() {
    rect(obX[0], obY[0], obX[6], obY[6]);
    rect(obX[1], obY[1], obX[7], obY[7]);
    rect(obX[2], obY[2], obX[8], obY[8]);
    rect(obX[3], obY[3], obX[9], obY[9]);
    rect(obX[4], obY[4], obX[10], obY[10]);
    rect(obX[5], obY[5], obX[11], obY[11]);
